...
predictions_df = pd.read_csv('predictions/injury_predictions_df_2.csv')
...
def load_player_data(player_name):
    ...
    injury_model = pickle.load(open('predictions/injury_model_efficient.sav', 'rb'))
    injury_scaler = pickle.load(open('predictions/injury_scaler_efficient.sav', 'rb'))
